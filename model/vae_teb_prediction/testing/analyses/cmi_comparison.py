...
from model.vae_teb_prediction.testing.collectors import collect_cmi_features
from model.vae_teb_prediction.testing.metrics import _rankdata_1d
...
try:  # pragma: no cover - plotting is optional and must never fail the analysis
    from model.vae_teb_prediction.testing.visualizers import plot_cmi_comparison
...
def _attach_empirical_te(
    ...
    if empirical_te_csv is None:
        return False
    try:
        from model.vae_teb_prediction.testing.TE_Calculated.cmi_adapter import (
