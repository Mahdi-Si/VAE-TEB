...
def run_coherence_analysis(
    ...
    *,
            ...
            for idx in range(batch_size):
                ...
                if detailed_saved < max_detailed_samples:
                    ...
                    plot_coherence_signals(
                        ...
                        fhr_orig,
                        fhr_recon,
                        sample_dir / f"{sample_name}_signals.pdf",
                        fs=fs,
                        title=signal_title,
                    )
                    ...
                    for method in tf_methods:
                        try:
                            ...
                            plot_time_frequency_coherence(
                                ...
                                tf_map["times"],
                                tf_map["coherence"],
                                output_path=sample_dir / f"{sample_name}_time_frequency_{suffix}.pdf",
                                max_freq=time_frequency_max_freq,
                    ...
                    try:
                        if window_tf["coherence"].size == 0:
                            ...
                            plot_time_frequency_coherence(
                                ...
                                window_tf["times"],
                                window_tf["coherence"],
                                output_path=sample_dir / f"{sample_name}_windowed_coherence.pdf",
                                max_freq=time_frequency_max_freq,
                            ...
                            if sample_window_band is not None:
                                ...
                                if not window_band_df.empty:
                                    _plot_band_trends(
                                        window_band_df,
                                        sample_dir / f"{sample_name}_window_band_coherence.pdf",
                                        x_col="window_index",
                                    ...
                                    if band_recon:
                                        ...
                                        if delta_rows:
                                            ...
                                            _plot_band_trends(
                                                window_delta_df,
                                                sample_dir / f"{sample_name}_window_band_coherence_delta.pdf",
                                                x_col="window_index",
                                                x_label="Window index",
                    ...
                    try:
                        if relative_tf["coherence"].size == 0:
                            ...
                            plot_time_frequency_coherence(
                                ...
                                relative_tf["times"],
                                relative_tf["coherence"],
                                output_path=sample_dir / f"{sample_name}_relative_window_time_frequency_stft.pdf",
                                max_freq=time_frequency_max_freq,
                            ...
                            if relative_tf.get("coherence_std") is not None:
                                plot_time_frequency_map(
                                    ...
                                    output_path=sample_dir / f"{sample_name}_relative_window_time_frequency_stft_std.pdf",
                                    max_freq=time_frequency_max_freq,
                            ...
                            if relative_tf.get("coherence_cv") is not None:
                                plot_time_frequency_map(
                                    ...
                                    output_path=sample_dir / f"{sample_name}_relative_window_time_frequency_stft_cv.pdf",
                                    max_freq=time_frequency_max_freq,
                            ...
                            if sample_relative_band is not None:
                                ...
                                if not relative_band_df.empty:
                                    _plot_band_trends(
                                        relative_band_df,
                                        sample_dir / f"{sample_name}_relative_band_coherence.pdf",
                                    ...
                                    if band_recon:
                                        ...
                                        if delta_rows:
                                            ...
                                            _plot_band_trends(
                                                relative_delta_df,
                                                sample_dir / f"{sample_name}_relative_band_coherence_delta.pdf",
                                                x_col="relative_frame_index",
                                                x_label="STFT frame index",
                        ...
                        if "wavelet" in tf_methods:
                            if relative_tf_wavelet["coherence"].size == 0:
                                ...
                                plot_time_frequency_coherence(
                                    ...
                                    relative_tf_wavelet["times"],
                                    relative_tf_wavelet["coherence"],
                                    output_path=sample_dir / f"{sample_name}_relative_window_time_frequency_wavelet.pdf",
                                    max_freq=time_frequency_max_freq,
                                ...
                                if relative_tf_wavelet.get("coherence_std") is not None:
                                    plot_time_frequency_map(
                                        ...
                                        output_path=sample_dir / f"{sample_name}_relative_window_time_frequency_wavelet_std.pdf",
                                        max_freq=time_frequency_max_freq,
                                ...
                                if relative_tf_wavelet.get("coherence_cv") is not None:
                                    plot_time_frequency_map(
                                        ...
                                        output_path=sample_dir / f"{sample_name}_relative_window_time_frequency_wavelet_cv.pdf",
                                        max_freq=time_frequency_max_freq,
                                ...
                                if relative_tf_wavelet.get("plv") is not None:
                                    plot_time_frequency_map(
                                        ...
                                        output_path=sample_dir / f"{sample_name}_relative_window_wavelet_plv.pdf",
                                        max_freq=time_frequency_max_freq,
                                ...
                                if relative_tf_wavelet.get("phase_mean") is not None:
                                    plot_time_frequency_map(
                                        ...
                                        output_path=sample_dir / f"{sample_name}_relative_window_wavelet_phase.pdf",
                                        max_freq=time_frequency_max_freq,
                                ...
                                if sample_relative_band_wavelet is not None:
                                    ...
                                    if not relative_band_df.empty:
                                        _plot_band_trends(
                                            relative_band_df,
                                            sample_dir / f"{sample_name}_relative_band_coherence_wavelet.pdf",
                                        ...
                                        if band_recon:
                                            ...
                                            _plot_band_trends(
                                                relative_delta_df,
                                                sample_dir / f"{sample_name}_relative_band_coherence_delta_wavelet.pdf",
                                                x_col="relative_time_sec",
                                                x_label="Time From Window Start (seconds)",
                    ...
                    try:
                        if sample_relative_perm_stft is not None:
                            plot_time_frequency_map(
                                ...
                                output_path=sample_dir / f"{sample_name}_relative_window_perm_upper_stft.pdf",
                                max_freq=time_frequency_max_freq,
                    ...
                    try:
                        if sample_relative_perm_wavelet is not None:
                            plot_time_frequency_map(
                                ...
                                output_path=sample_dir / f"{sample_name}_relative_window_perm_upper_wavelet.pdf",
                                max_freq=time_frequency_max_freq,
                        ...
                        if mu_pr_window is not None and mu_pr_window.size > 0:
                            ...
                            if end <= len(fhr_orig_full):
                                ...
                                plot_coherence_signals(
                                    ...
                                    ref_win,
                                    pred_win,
                                    sample_dir / f"{window_prefix}_signals.pdf",
                                    fs=fs,
                                    title=window_title,
                                )
                                ...
                                if nperseg_used >= 2:
                                    ...
                                    if freq_win.size > 0:
                                        plot_coherence_spectrum(
                                            freq_win,
                                            coh_win,
                                            sample_dir / f"{window_prefix}_coherence_spectrum.pdf",
                                ...
                                for method in tf_methods:
                                    ...
                                    plot_time_frequency_coherence(
                                        ...
                                        tf_map["times"],
                                        tf_map["coherence"],
                                        output_path=sample_dir / f"{window_prefix}_time_frequency_{suffix}.pdf",
                                        max_freq=time_frequency_max_freq,
                                ...
                                if psd_freq.size > 0:
                                    plot_psd_comparison(
                                        ...
                                        sample_dir,
                                        filename=f"{window_prefix}_psd.pdf",
                                    )
                                ...
                                if lags_sec.size > 0:
                                    plot_cross_correlation(
                                        ...
                                        np.zeros_like(corr),
                                        sample_dir,
                                        filename=f"{window_prefix}_cross_correlation.pdf",
                                    )
                    except Exception as e:
                    ...
                    try:
                        if sample_bandpower is not None and not sample_bandpower.empty:
                            ...
                            _plot_band_trends(
                                sample_bandpower,
                                sample_dir / f"{sample_name}_window_bandpower.pdf",
                                x_col="window_index",
                                x_label="Window index",
                    ...
                    try:
                        ...
                        if psd_freq.size > 0:
                            plot_psd_comparison(
                                ...
                                filename=f"{sample_name}_psd.pdf",
                            )
                    except Exception as e:
                    ...
                    try:
                        ...
                        if lags_sec.size > 0:
                            plot_cross_correlation(
                                ...
                                np.zeros_like(corr),
                                sample_dir,
                                filename=f"{sample_name}_cross_correlation.pdf",
                            )
                    except Exception as e:
    ...
    if epoch_records:
        ...
        if "epoch" in df_epochs.columns:
            ...
            if epoch_band_rows:
                ...
                _plot_band_trends(
                    epoch_agg,
                    output_dir / "epoch_coherence_trends.pdf",
                    x_col="hour_bin",
    ...
    if window_records:
        ...
        _plot_band_trends(
            window_agg,
            output_dir / "window_coherence_trends.pdf",
        ...
        _plot_band_trends(
            window_agg,
            output_dir / "window_coherence_trends_index.pdf",
            x_col="window_index",
            x_label="Window index",
        ...
        if "coherence_delta" in df_windows.columns:
            ...
            _plot_band_trends(
                window_delta,
                output_dir / "window_coherence_delta_trends.pdf",
                x_col="window_start_sec",
                x_label="Window Start (seconds)",
            ...
            _plot_band_trends(
                window_delta,
                output_dir / "window_coherence_delta_trends_index.pdf",
                x_col="window_index",
                x_label="Window index",
    ...
    if relative_records:
        ...
        _plot_band_trends(
            relative_agg,
            output_dir / "relative_window_coherence_trends.pdf",
            x_col="relative_time_sec",
            x_label="Time From Window Start (seconds)",
        ...
        _plot_band_trends(
            relative_index_agg,
            output_dir / "relative_window_coherence_trends_index.pdf",
            x_col="relative_frame_index",
            x_label="STFT frame index",
        ...
        if "coherence_delta" in df_relative.columns:
            ...
            _plot_band_trends(
                relative_delta,
                output_dir / "relative_window_coherence_delta_trends.pdf",
                x_col="relative_time_sec",
                x_label="Time From Window Start (seconds)",
            ...
            _plot_band_trends(
                ...
                output_dir / "relative_window_coherence_delta_trends_index.pdf",
                x_col="relative_frame_index",
                x_label="STFT frame index",
    ...
    if relative_tf_mean_list and relative_tf_template is not None:
        ...
        if tf_stack.size:
            ...
            plot_time_frequency_coherence(
                ...
                tf_mean,
                output_path=output_dir / "relative_window_time_frequency_mean_stft.pdf",
                max_freq=time_frequency_max_freq,
            ...
            plot_time_frequency_map(
                ...
                relative_tf_template["times"],
                tf_std,
                output_path=output_dir / "relative_window_time_frequency_std_stft.pdf",
                max_freq=time_frequency_max_freq,
        ...
        if tf_std_stack.size:
            ...
            plot_time_frequency_map(
                ...
                relative_tf_template["times"],
                tf_std_mean,
                output_path=output_dir / "relative_window_time_frequency_window_std_stft.pdf",
                max_freq=time_frequency_max_freq,
        ...
        if tf_cv_stack.size:
            ...
            plot_time_frequency_map(
                ...
                relative_tf_template["times"],
                tf_cv_mean,
                output_path=output_dir / "relative_window_time_frequency_window_cv_stft.pdf",
                max_freq=time_frequency_max_freq,
    ...
    if relative_tf_wavelet_mean_list and relative_tf_wavelet_template is not None:
        ...
        if tfw_stack.size:
            ...
            plot_time_frequency_coherence(
                ...
                tfw_mean,
                output_path=output_dir / "relative_window_time_frequency_mean_wavelet.pdf",
                max_freq=time_frequency_max_freq,
            ...
            plot_time_frequency_map(
                ...
                relative_tf_wavelet_template["times"],
                tfw_std,
                output_path=output_dir / "relative_window_time_frequency_std_wavelet.pdf",
                max_freq=time_frequency_max_freq,
        ...
        if tfw_std_stack.size:
            ...
            plot_time_frequency_map(
                ...
                relative_tf_wavelet_template["times"],
                tfw_std_mean,
                output_path=output_dir / "relative_window_time_frequency_window_std_wavelet.pdf",
                max_freq=time_frequency_max_freq,
        ...
        if tfw_cv_stack.size:
            ...
            plot_time_frequency_map(
                ...
                relative_tf_wavelet_template["times"],
                tfw_cv_mean,
                output_path=output_dir / "relative_window_time_frequency_window_cv_wavelet.pdf",
                max_freq=time_frequency_max_freq,
        ...
        if relative_tf_wavelet_plv_list:
            ...
            if plv_stack.size:
                ...
                plot_time_frequency_map(
                    ...
                    relative_tf_wavelet_template["times"],
                    plv_mean,
                    output_path=output_dir / "relative_window_wavelet_plv.pdf",
                    max_freq=time_frequency_max_freq,
        ...
        if relative_tf_wavelet_phase_list:
            ...
            if phase_stack.size:
                ...
                plot_time_frequency_map(
                    ...
                    relative_tf_wavelet_template["times"],
                    phase_mean,
                    output_path=output_dir / "relative_window_wavelet_phase_mean.pdf",
                    max_freq=time_frequency_max_freq,
    ...
    if horizon_early_list and relative_tf_template is not None:
        ...
        if early_stack.size and late_stack.size:
            ...
            plot_horizon_spectra(
                ...
                late_mean,
                late_std,
                output_path=output_dir / "relative_window_horizon_spectra_stft.pdf",
                max_freq=time_frequency_max_freq,
        ...
        if delta_stack.size:
            ...
            plot_spectrum_delta(
                ...
                delta_mean,
                delta_std,
                output_path=output_dir / "relative_window_horizon_delta_stft.pdf",
                max_freq=time_frequency_max_freq,
    ...
    if horizon_early_wavelet_list and relative_tf_wavelet_template is not None:
        ...
        if early_stack.size and late_stack.size:
            ...
            plot_horizon_spectra(
                ...
                late_mean,
                late_std,
                output_path=output_dir / "relative_window_horizon_spectra_wavelet.pdf",
                max_freq=time_frequency_max_freq,
        ...
        if delta_stack.size:
            ...
            plot_spectrum_delta(
                ...
                delta_mean,
                delta_std,
                output_path=output_dir / "relative_window_horizon_delta_wavelet.pdf",
                max_freq=time_frequency_max_freq,
    ...
    if permutation_upper_list and relative_tf_template is not None:
        ...
        if perm_upper_stack.size:
            ...
            plot_time_frequency_map(
                ...
                relative_tf_template["times"],
                perm_upper_mean,
                output_path=output_dir / "relative_window_perm_upper_stft.pdf",
                max_freq=time_frequency_max_freq,
        ...
        if perm_lower_stack.size:
            ...
            plot_time_frequency_map(
                ...
                relative_tf_template["times"],
                perm_lower_mean,
                output_path=output_dir / "relative_window_perm_lower_stft.pdf",
                max_freq=time_frequency_max_freq,
    ...
    if permutation_upper_wavelet_list and relative_tf_wavelet_template is not None:
        ...
        if perm_upper_stack.size:
            ...
            plot_time_frequency_map(
                ...
                relative_tf_wavelet_template["times"],
                perm_upper_mean,
                output_path=output_dir / "relative_window_perm_upper_wavelet.pdf",
                max_freq=time_frequency_max_freq,
        ...
        if perm_lower_stack.size:
            ...
            plot_time_frequency_map(
                ...
                relative_tf_wavelet_template["times"],
                perm_lower_mean,
                output_path=output_dir / "relative_window_perm_lower_wavelet.pdf",
                max_freq=time_frequency_max_freq,
    ...
    if relative_records_wavelet:
        ...
        _plot_band_trends(
            ...
            output_dir / "relative_window_coherence_trends_wavelet.pdf",
            x_col="relative_time_sec",
            x_label="Time From Window Start (seconds)",
        ...
        _plot_band_trends(
            ...
            output_dir / "relative_window_coherence_trends_index_wavelet.pdf",
            x_col="relative_frame_index",
        ...
        if "coherence_delta" in df_relative_wavelet.columns:
            ...
            _plot_band_trends(
                ...
                output_dir / "relative_window_coherence_delta_trends_wavelet.pdf",
                x_col="relative_time_sec",
                x_label="Time From Window Start (seconds)",
            ...
            _plot_band_trends(
                ...
                output_dir / "relative_window_coherence_delta_trends_index_wavelet.pdf",
                x_col="relative_frame_index",
                x_label="Wavelet time index",
    ...
    if bandpower_records:
        ...
        _plot_band_trends(
            bandpower_agg,
            output_dir / "window_bandpower_trends.pdf",
            x_col="window_start_sec",
            x_label="Window Start (seconds)",
        ...
        _plot_band_trends(
            bandpower_agg,
            output_dir / "window_bandpower_trends_index.pdf",
            x_col="window_index",
            x_label="Window index",
        ...
        if "bandpower_delta" in df_bandpower.columns:
            ...
            _plot_band_trends(
                bandpower_delta,
                output_dir / "window_bandpower_delta_trends.pdf",
                x_col="window_start_sec",
                x_label="Window Start (seconds)",
            ...
            _plot_band_trends(
                bandpower_delta,
                output_dir / "window_bandpower_delta_trends_index.pdf",
                x_col="window_index",
                x_label="Window index",
    ...
    with open(summary_path, "w") as f:
        ...
        f.write("\nAdditional outputs:\n")
        f.write("  reconstruction_coherence.pdf\n")
        f.write("  psd_comparison.pdf\n")
        f.write("  cross_correlation.pdf\n")
        if include_up_coherence and "up_coherence_original_mean" in results:
            f.write("  up_fhr_coherence.pdf\n")
        f.write("  epoch_coherence_summary.csv\n")
        f.write("  epoch_coherence_aggregate.csv\n")
        f.write("  epoch_coherence_trends.pdf\n")
        f.write("  window_coherence_summary.csv\n")
        f.write("  window_coherence_aggregate.csv\n")
        f.write("  window_coherence_trends.pdf\n")
        f.write("  window_coherence_trends_index.pdf\n")
        f.write("  window_coherence_delta_aggregate.csv\n")
        f.write("  window_coherence_delta_trends.pdf\n")
        f.write("  window_coherence_delta_trends_index.pdf\n")
        f.write("  relative_window_coherence_summary.csv\n")
        f.write("  relative_window_coherence_aggregate.csv\n")
        f.write("  relative_window_coherence_trends.pdf\n")
        f.write("  relative_window_coherence_index_aggregate.csv\n")
        f.write("  relative_window_coherence_trends_index.pdf\n")
        f.write("  relative_window_coherence_delta_aggregate.csv\n")
        f.write("  relative_window_coherence_delta_trends.pdf\n")
        f.write("  relative_window_coherence_delta_index_aggregate.csv\n")
        f.write("  relative_window_coherence_delta_trends_index.pdf\n")
        f.write("  relative_window_time_frequency_mean_stft.pdf\n")
        f.write("  relative_window_time_frequency_std_stft.pdf\n")
        f.write("  relative_window_time_frequency_window_std_stft.pdf\n")
        f.write("  relative_window_time_frequency_window_cv_stft.pdf\n")
        f.write("  relative_window_horizon_spectra_stft.pdf\n")
        f.write("  relative_window_horizon_delta_stft.pdf\n")
        f.write("  relative_window_horizon_spectra_stft.csv\n")
        f.write("  relative_window_perm_upper_stft.pdf\n")
        f.write("  relative_window_perm_lower_stft.pdf\n")
        if relative_records_wavelet:
            f.write("  relative_window_coherence_summary_wavelet.csv\n")
            f.write("  relative_window_coherence_aggregate_wavelet.csv\n")
            f.write("  relative_window_coherence_trends_wavelet.pdf\n")
            f.write("  relative_window_coherence_index_aggregate_wavelet.csv\n")
            f.write("  relative_window_coherence_trends_index_wavelet.pdf\n")
            f.write("  relative_window_coherence_delta_aggregate_wavelet.csv\n")
            f.write("  relative_window_coherence_delta_trends_wavelet.pdf\n")
            f.write("  relative_window_coherence_delta_index_aggregate_wavelet.csv\n")
            f.write("  relative_window_coherence_delta_trends_index_wavelet.pdf\n")
            f.write("  relative_window_time_frequency_mean_wavelet.pdf\n")
            f.write("  relative_window_time_frequency_std_wavelet.pdf\n")
            f.write("  relative_window_time_frequency_window_std_wavelet.pdf\n")
            f.write("  relative_window_time_frequency_window_cv_wavelet.pdf\n")
            f.write("  relative_window_wavelet_plv.pdf\n")
            f.write("  relative_window_wavelet_phase_mean.pdf\n")
            f.write("  relative_window_horizon_spectra_wavelet.pdf\n")
            f.write("  relative_window_horizon_delta_wavelet.pdf\n")
            f.write("  relative_window_horizon_spectra_wavelet.csv\n")
            f.write("  relative_window_perm_upper_wavelet.pdf\n")
            f.write("  relative_window_perm_lower_wavelet.pdf\n")
        f.write("  window_bandpower_summary.csv\n")
        f.write("  window_bandpower_aggregate.csv\n")
        f.write("  window_bandpower_trends.pdf\n")
        f.write("  window_bandpower_trends_index.pdf\n")
        f.write("  window_bandpower_delta_aggregate.csv\n")
        f.write("  window_bandpower_delta_trends.pdf\n")
        f.write("  window_bandpower_delta_trends_index.pdf\n")
        f.write("  samples/<sample>_signals.pdf\n")
        f.write("  samples/<sample>_time_frequency_stft.pdf\n")
        f.write("  samples/<sample>_time_frequency_wavelet.pdf\n")
        f.write("  samples/<sample>_windowed_coherence.pdf\n")
        f.write("  samples/<sample>_relative_window_time_frequency_stft.pdf\n")
        f.write("  samples/<sample>_relative_window_time_frequency_stft_std.pdf\n")
        f.write("  samples/<sample>_relative_window_time_frequency_stft_cv.pdf\n")
        f.write("  samples/<sample>_relative_window_time_frequency_wavelet.pdf\n")
        f.write("  samples/<sample>_relative_window_time_frequency_wavelet_std.pdf\n")
        f.write("  samples/<sample>_relative_window_time_frequency_wavelet_cv.pdf\n")
        f.write("  samples/<sample>_window_band_coherence.pdf\n")
        f.write("  samples/<sample>_window_band_coherence_delta.pdf\n")
        f.write("  samples/<sample>_relative_band_coherence.pdf\n")
        f.write("  samples/<sample>_relative_band_coherence_delta.pdf\n")
        f.write("  samples/<sample>_relative_band_coherence_wavelet.pdf\n")
        f.write("  samples/<sample>_relative_band_coherence_delta_wavelet.pdf\n")
        f.write("  samples/<sample>_relative_window_wavelet_plv.pdf\n")
        f.write("  samples/<sample>_relative_window_wavelet_phase.pdf\n")
        f.write("  samples/<sample>_relative_window_perm_upper_stft.pdf\n")
        f.write("  samples/<sample>_relative_window_perm_upper_wavelet.pdf\n")
        f.write("  samples/<sample>_single_window_*_signals.pdf\n")
        f.write("  samples/<sample>_single_window_*_coherence_spectrum.pdf\n")
        f.write("  samples/<sample>_single_window_*_time_frequency_stft.pdf\n")
        f.write("  samples/<sample>_single_window_*_time_frequency_wavelet.pdf\n")
        f.write("  samples/<sample>_single_window_*_psd.pdf\n")
        f.write("  samples/<sample>_single_window_*_cross_correlation.pdf\n")
        f.write("  samples/<sample>_window_bandpower.pdf\n")
        f.write("  samples/<sample>_psd.pdf\n")
        f.write("  samples/<sample>_cross_correlation.pdf\n")
