...
**This module is a behaviour-equivalent copy of the raw pipeline's**, and is classified as such in
...
$H \cdot C_{\mathrm{keep}}$ coefficients per anchor rather than $H \cdot R$ raw
...
and the three scores below are in exactly those nats.
"""
