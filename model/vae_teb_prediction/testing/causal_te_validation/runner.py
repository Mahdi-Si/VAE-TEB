...
from . import test_03_band_uplift_regression
...
def run_causal_te_validation(
    ...
    *,
    ...
    Args:
        ...
        band_forecast_dir: Path to ``<root>/frequency_band_forecast``.
    ...
    test_03 = _safe_run(
        "test_03_band_uplift",
        test_03_band_uplift_regression.run,
        histogram_csv=Path(histogram_csv),
        band_forecast_dir=Path(band_forecast_dir),
        output_dir=output_dir / "band_uplift_regression",
    )
    test_09 = _safe_run(
        "test_09_dim_spec",
    ...
    plot_calls = [
        ...
        ("test_03_forest",
         lambda: plots.plot_band_alpha_forest(
             output_dir / "band_uplift_regression" / "per_band_coefficients.csv",
             output_dir / "band_uplift_regression" / "forest_alpha1_by_band.pdf",
         )),
        ("test_04_hist",
    ...
    summary = {
        ...
        "inference_method_per_test": {
            ...
            "test_03_band_uplift": test_03.get("evidence", {}).get("method", "unknown"),
        },
    }
