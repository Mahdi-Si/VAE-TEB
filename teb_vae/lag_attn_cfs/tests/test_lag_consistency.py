...
$\Delta(\ell + \delta)$, which is exactly what ``lag_compensated_seconds`` computes. The
distinction this file defends survives either way: $d_c$ is a shift and belongs on the axis,
$W'_c$ is a warm-up and does not.
