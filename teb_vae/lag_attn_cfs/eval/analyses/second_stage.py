...
arithmetic lives in :func:`~teb_vae.lag_attn_cfs.eval.cohort.add_second_stage_bins` and is pinned
...
def eligible_rows(per_sample: pd.DataFrame) -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    Returns:
        ...
        :func:`~teb_vae.lag_attn_cfs.eval.cohort.second_stage_eligibility`, and the subset of
