...
``__main__`` block in ``te_kld_comparison``::
    ...
    python -m model.vae_teb_prediction.model.model_raw.testing.TE_Calculated.te_kld_comparison
...
from model.vae_teb_prediction.model.model_raw.testing.TE_Calculated.te_kld_distance_metrics import (
...
from model.vae_teb_prediction.model.model_raw.testing.TE_Calculated.te_kld_comparison import (
    run_comparison,
)
