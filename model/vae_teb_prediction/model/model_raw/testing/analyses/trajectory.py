...
from model.vae_teb_prediction.model.model_raw.testing.collectors import _extract_epoch, _extract_guid, _extract_label
...
class TrajectoryAnalyzer:
    ...
    def _collect_data(self) -> Tuple[pd.DataFrame, pd.DataFrame]:
        ...
        with self.runner.inference_mode():
            for batch in self.runner.iter_batches(self.loader):
                batch_size = batch.fhr.size(0)  # raw port: batch has fhr, not fhr_st
    ...
    def _plot_guid_3d_trajectories(
        ...
        for guid in selected:
            ...
            try:
                from model.vae_teb_prediction.model.model_raw.testing.visualizers import plot_guid_trajectory_3d
                plot_guid_trajectory_3d(
                    traj_3d,
