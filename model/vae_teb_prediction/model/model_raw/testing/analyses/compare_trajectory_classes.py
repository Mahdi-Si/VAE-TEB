...
Usage:
    python -m model.vae_teb_prediction.model.model_raw.testing.analyses.compare_trajectory_classes \
...
def _plot_feature_boxplots(
    ...
    try:
        from model.vae_teb_prediction.model.model_raw.testing.visualizers import plot_feature_boxplots
...
def _plot_dimension_heatmap(
    ...
    try:
        from model.vae_teb_prediction.model.model_raw.testing.visualizers import plot_dimension_significance_heatmap
...
def _plot_distributional_distances(
    ...
    if not pairwise_summary:
        return
    try:
        from model.vae_teb_prediction.model.model_raw.testing.visualizers import plot_distributional_distances
